          ...
          <div className="container mx-auto px-4 py-8">
            <div className="flex flex-wrap -mx-4">
              ...
              <div className="w-full md:w-1/2 px-4">
                ...
                <div className="flex space-x-4 mb-6">
                  <Link to="/card">
                    <button className="bg-indigo-600 text-white px-6 py-2 rounded-md hover:bg-indigo-700 focus:outline-none">
                      Add to Cart
                    </button>
                  </Link>
                  <Link to="/shop">
                    <button className="bg-gray-200 text-gray-800 px-6 py-2 rounded-md hover:bg-gray-300 focus:outline-none">
                      Back
                    </button>
                  </Link>
                </div>
