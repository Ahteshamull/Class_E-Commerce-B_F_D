    ...
    products.map((product) => (
      <Card key={product._id} className=" p-4  shadow-md rounded-lg">
        <div className="flex flex-col items-center">
          ...
          <Typography variant="small" color="blue-gray" className="text-center mb-2">
            {product.description}
          </Typography>
          ...
          <Typography variant="small" color="blue-gray" className="text-center mb-4">
            {product.category}
          </Typography>
          ...
          <div className="flex justify-between  w-full">
            ...
            <Tooltip content={product.isFeature ? "Unfeature Product" : "Feature Product"}>
              <IconButton
                variant="text"
                onClick={() => handleFeatureProduct(product._id)}
              >
                <StarIcon
                  className={`h-5 w-5 ${product.isFeature ? "text-yellow-500" : "text-gray-500"}`}
                />
              </IconButton>
            </Tooltip>
          </div>
...
//       <Card key={product._id} className="w-full p-4 shadow-lg rounded-lg">
//         <div className="flex flex-col items-center">
//           <img
